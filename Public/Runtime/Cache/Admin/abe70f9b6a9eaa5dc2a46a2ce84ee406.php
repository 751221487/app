...
<div class="easyui-dialog" title="用户登录" style="width:380px;height:240px" data-options="closable:false,iconCls:'icons-lock-lock',buttons:[{text:'登录',iconCls:'icons-user-user_go',handler:login}]">
	...
	<form id='form' method="post" style="margin-top: 20px;">
		<div class="input">
			...
			<input class="easyui-validatebox" type="text" name="username" value="admin" data-options="required:true,validType:{length:[2,20]},tipPosition:'bottom'"  />
		</div>
		<div class="input">
			<label for="password">密&nbsp;&nbsp;码:</label>  
			<input class="easyui-validatebox" type="password" name="password" value="123456" data-options="required:true,validType:{length:[6,20]},tipPosition:'bottom'" />
		</div>
	</form> 
</div>
