...
var adminAreaModule = {
	...
	add: function(parentid){
		...
		var href = '<?php echo U('Admin/areaAdd');?>';
				...
				handler: function(){
					$(that.dialog).find('form').eq(0).form('submit', {
						onSubmit: function(){
							...
							$.post('<?php echo U('Admin/areaAdd?dosubmit=1');?>', $(this).serialize(), function(res){
	...
	edit: function(id){
		...
		var href = '<?php echo U('Admin/areaEdit');?>';
				...
				handler: function(){
					$(that.dialog).find('form').eq(0).form('submit', {
						onSubmit: function(){
							...
							$.messager.progress({text:'处理中，请稍候...'});
							var action = '<?php echo U('Admin/areaEdit?dosubmit=1');?>';
	...
	delete: function(id){
		...
		$.messager.confirm('提示信息', '确定要删除吗？', function(result){
			...
			$.messager.progress({text:'处理中，请稍候...'});
			$.post('<?php echo U('Admin/areaDelete');?>', {id: id}, function(res){
				$.messager.progress('close');
